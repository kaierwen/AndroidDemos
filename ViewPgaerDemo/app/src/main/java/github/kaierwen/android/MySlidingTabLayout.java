package github.kaierwen.android;
 ...
 * <p>
 * 1.添加两个属性：tl_textSelectSize和tl_textUnselectSize，用于设置Tab文字大小
 *
 * @author qiaofeng
 * @see <a href="https://github.com/H07000223/FlycoTabLayout/issues/487">link</a>
 * @since 2020/10/13
 */
public class MySlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    private float mTextSelectSize; //新增属性
    private float mTextUnselectSize; //新增属性
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mTextSelectSize = ta.getDimension(R.styleable.SlidingTabLayout_tl_textSelectSize, sp2px(0f));//将默认值设为0，是为了不影响mTextSelectSize
        mTextUnselectSize = ta.getDimension(R.styleable.SlidingTabLayout_tl_textUnselectSize, sp2px(0f));//将默认值设为0，是为了不影响mTextSelectSize
...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
            ...
            if (tv_tab_title != null) {
                ...
                if (mTextSelectSize != 0 && mTextUnselectSize != 0) {
                    // 外部有设置mTextSelectSize和mTextUnselectSize的值，取出他们的值，如果都没设置值，那就使用mTextsize的值
